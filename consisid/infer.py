...
if __name__ == "__main__":
    ...
    # input arguments
    parser.add_argument("--img_file_path", type=str, default="/root/autodl-tmp/yufei/DeepFaceLab/output/-2KGPYEFnsU_2/HQ_face/HQ_00007_0.jpg", help="should contain clear face, preferably half-body or full-body image")
    parser.add_argument("--prompt", type=str, default="A young woman is organizing community gatherings. She is wearing smart casual attire, facilitating neighborhood connections and activities. The venue features community spaces, event areas, and social zones. Lighting appropriate for community functions")
